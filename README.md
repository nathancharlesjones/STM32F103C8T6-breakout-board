...
|Part|Cost<sup>1</sup>|Stock on JLC PCB<sup>1</sup>|Processor|Core Size|Speed|Connectivity|Peripherals|I/O|Program memory size|RAM size|EEPROM size|Data converters|
|---|---|---|---|---|---|---|---|---|---|---|---|---|
